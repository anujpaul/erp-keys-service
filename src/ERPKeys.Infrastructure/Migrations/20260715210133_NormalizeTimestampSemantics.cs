...
{
    /// <inheritdoc />
    public partial class NormalizeTimestampSemantics : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Existing timestamp-without-time-zone values were written as UTC clock
            // values. Interpret them as UTC while changing instant columns to
            // timestamptz so PostgreSQL does not shift them using the session zone.
